...
const GlobalStats = ({ stats, loading, error, currency = 'usd', onRetry }) => {
  if (loading) return (
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm rounded-xl px-2 py-1 flex items-center overflow-x-auto no-scrollbar whitespace-nowrap">
      <StatItem 
        label="Market Cap" 
