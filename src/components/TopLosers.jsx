...
const TopLosers = ({ coins, loading, currency = 'usd' }) => {
      ...
      <div className="grid grid-cols-2 gap-4">
        {losers.map((coin) => (
          <div
            ...
            className="flex flex-col gap-2 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 hover:border-rose-500/50 transition-colors duration-200 cursor-pointer"
          >
